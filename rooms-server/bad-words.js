...
const RAW = [
  // --- Türkçe ---
  'siktir', 'sikeyim', 'sikerim', 'sikik', 'siktir git', 'sikimde',
  'orospu', 'orospucocugu', 'oç', 'oçocuğu', 'piç', 'pezevenk', 'kahpe',
  'kaltak', 'sürtük', 'yavşak', 'gavat', 'ibne', 'puşt', 'top',
  'amcık', 'amına', 'amınakoyayım', 'amuğa', 'amk', 'aq', 'awk',
  'göt', 'götveren', 'götoş', 'götlek', 'taşşak', 'yarrak', 'yarak',
  'salak', 'aptal', 'gerizekalı', 'dangalak', 'öküz', 'eşşek', 'şerefsiz',
  'oğlibne', 'anan', 'ananı', 'avrat',
  // --- İngilizce ---
  'fuck', 'fucker', 'fucking', 'motherfucker', 'fuckoff', 'stfu',
  'shit', 'bullshit', 'bitch', 'asshole', 'ass', 'bastard', 'dick',
  'pussy', 'cunt', 'whore', 'slut', 'nigger', 'nigga', 'retard',
  'faggot', 'fag', 'cock', 'wanker', 'jerk',
];
...
const PREFIX = [
  'orospu', 'siktir', 'sikerim', 'sikeyim', 'sikik', 'yavsak', 'pezevenk',
  'kahpe', 'kaltak', 'surtuk', 'gerizekal', 'dangalak', 'serefsiz',
  'gotveren', 'gotoş', 'gotos', 'ibne', 'pust', 'amcik', 'amina',
  'fuck', 'shit', 'bitch', 'asshole', 'bastard', 'pussy', 'cunt', 'whore',
  'slut', 'faggot', 'nigger', 'nigga', 'motherfuck', 'wanker', 'retard',
].map(normalizeToken);
